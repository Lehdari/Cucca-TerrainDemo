...
int main(void) {
    ...
    terrainVSBinaryInitInfo.fileName = "shaders/VS_Terrain.glsl";
    ...
    terrainTCSBinaryInitInfo.fileName = "shaders/TCS_Terrain.glsl";
    ...
    terrainTESBinaryInitInfo.fileName = "shaders/TES_Terrain.glsl";
    ...
    terrainFSBinaryInitInfo.fileName = "shaders/FS_Terrain.glsl";
